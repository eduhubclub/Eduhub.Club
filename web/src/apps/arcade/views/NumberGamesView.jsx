...
/**
 * Number Games selection board — puzzle cabinets for digit play.
 */
export function NumberGamesView({ isDarkMode, onOpenGame }) {
    ...
    >
      <div className="arcade-panel mx-3 mt-3 px-4 py-3 sm:mx-4">
        ...
        <p className="mt-2 text-[8px] leading-relaxed text-[#bbf7d0]">
          Digits, logic, and classroom-friendly puzzles.
        </p>
      </div>
